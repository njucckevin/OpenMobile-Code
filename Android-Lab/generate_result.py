...
def parse_args():
    ...
    group.add_argument("--api_base", type=str, default=None)
...
def main():
    args = parse_args()
    assert args.judge_model in ["glm4", "gpt-4o-2024-05-13", "gpt-5"], "We only support glm4 or gpt-4o for judge model"
