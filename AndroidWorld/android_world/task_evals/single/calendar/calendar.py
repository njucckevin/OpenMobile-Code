...
def generate_noise_events(
    ...
    n: int,
    filter_fn: Optional[Callable[[sqlite_schema_utils.CalendarEvent], bool]] = None,
...
class SimpleCalendarDeleteEvents(sqlite_validators.DeleteMultipleRows, _SimpleCalendar):
...
class SimpleCalendarDeleteEventsOnRelativeDay(SimpleCalendarDeleteEvents):
    ...
    template = (
        "In Simple Calendar Pro, delete all events scheduled for this" " {day_of_week}."
    )
