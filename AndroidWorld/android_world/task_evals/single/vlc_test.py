...
class VlcTestBase(parameterized.TestCase):
    ...
    def setUp(self):
        ...
        self.android_env_mock = mock.create_autospec(env_interface.AndroidEnvInterface)
        self.enter_context(
            mock.patch.object(
                a11y_grpc_wrapper,
                "A11yGrpcWrapper",
...
class TestCreateTwoPlaylists(VlcTaskEvalsTestBase):
    ...
    def test_is_successful_partial(self, playlist: Playlist):
        ...
        self.assertEqual(create_two_playlists_task.is_successful(self.env_mock), 0.5)
        create_two_playlists_task.tear_down(self.env_mock)
