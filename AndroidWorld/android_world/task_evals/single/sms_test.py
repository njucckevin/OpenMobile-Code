...
class TestSimpleSmsReplyMostRecent(test_utils.AdbEvalTestBase):
    ...
    def setUp(self):
        ...
        self.mock_text_emulator = mock.patch.object(adb_utils, "text_emulator").start()
        ...
        self.extract_package_name.return_value = "com.simplemobiletools.smsmessenger"
...
class TestSimpleSmsSendClipboardContent(test_utils.AdbEvalTestBase):
    ...
    def test_is_successful(self):
        ...
        self.mock_get_sent_messages.side_effect = [
            ...
            [
                "Row: 0, address={}, body={}, service_center=NULL, date={}".format(
                    number, clipboard_contents, date_ms
                )
            ],
        ]
...
class TestSimpleSmsSendReceivedAddress(test_utils.AdbEvalTestBase):
    ...
    def setUp(self):
        ...
        self.mock_add_contact = mock.patch.object(contacts_utils, "add_contact").start()
...
class TestMessagesResendTextMessage(test_utils.AdbEvalTestBase):
    ...
    def test_is_successful(self):
        ...
        initial_message = (
            "Row: 2, address={}, body=Hello World, service_center=NULL, date={}".format(
                agent_number, initial_date_ms
            )
        )
        expected_message = (
            "Row: 0, address={}, body=Hello World, service_center=NULL, date={}".format(
                agent_number, final_date_ms
            )
        )
        self.mock_get_sent_messages.side_effect = [
