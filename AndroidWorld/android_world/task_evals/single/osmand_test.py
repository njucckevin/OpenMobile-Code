...
class TestOsmAndMarker(absltest.TestCase):
    ...
    def test_empty_marker_matches_nothing(self):
        ...
        coords_match = osmand._marker_matches_location(marker, "47.1069970, 9.5274854")
    ...
    def test_marker_matches_name(self):
        ...
        name_match = osmand._marker_matches_location(marker, "Triesen, Liechtenstein")
...
class TestOsmAndTrack(absltest.TestCase):
    ...
    def test_lookup_unknown_target_waypoint(self):
        ...
        self.assertIsNone(
            osmand._lookup_location_coords(waypoint_name_not_in_preloaded_map_locations)
        )
    ...
    def test_lookup_coords_just_returns_coords(self):
        self.assertEqual((-1.234, 56.7), osmand._lookup_location_coords("-1.234, 56.7"))
    ...
    def test_track_doesnt_match_out_of_order(self):
        ...
        self.assertFalse(osmand._track_matches(track_points, reverse_order_waypoints))
