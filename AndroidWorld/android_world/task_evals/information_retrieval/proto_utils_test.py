...
class ProtoUtilsTest(parameterized.TestCase):
        ...
        [
            ...
            (
                ...
                [
                    ...
                    task_pb2.TaskParams(name="time", possible_values=["12:30", "5pm"]),
                    task_pb2.TaskParams(name="duration", possible_values=["15m", "1h"]),
                ],
                [
                    state_pb2.Event(
        ...
        [
            ...
            (
                ...
                [
                    ...
                    task_pb2.TaskParams(name="importance", possible_values=["0", "3"]),
                ],
                [
                    state_pb2.TasksAppTask(
    ...
    def test_format_initial_calendar_state_with_params(self):
        ...
        expected_exclusion_condition.operation = task_pb2.ExclusionCondition.EQUAL_TO
    ...
    @parameterized.parameters(
        [
            ...
            (
                ...
                [
                    datetime.datetime(year=2023, month=10, day=17, hour=12, minute=30),
    ...
    def test_check_agent_answer(self, agent_answer, task, expected: bool | Exception):
