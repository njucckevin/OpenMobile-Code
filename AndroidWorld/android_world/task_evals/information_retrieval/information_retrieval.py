...
from android_world.task_evals.information_retrieval import (
    calendar_utils as calendar_utils_ir,
)
from android_world.task_evals.information_retrieval import (
...
class InformationRetrieval(task_eval.TaskEval, abc.ABC):
    ...
    def initialize_task(self, env: interface.AsyncEnv) -> None:
        ...
        if (
            ...
            calendar_utils_ir.setup_task_state(relevant_state.calendar, exclusions, env)
        if self.is_tasks_task():
        ...
        if self.is_notes_task():
            joplin_app_utils.setup_task_state(relevant_state.notes_app, exclusions, env)
