...
DEFAULT_TASK_TEMPLATE = task_pb2.Task(
    ...
    task_params=[
        ...
        task_pb2.TaskParams(name="start_date", possible_values=["October 15 2023"]),
        task_pb2.TaskParams(name="title", possible_values=["test title"]),
        task_pb2.TaskParams(name="completed_date", possible_values=["October 16 2023"]),
...
class InformationRetrievalTaskForTest(information_retrieval.InformationRetrieval):
...
class InformationRetrievalTest(absltest.TestCase):
    ...
    def test_is_successful_datetime_match_succeeds(self):
        ...
        self.mock_task.initialize_task(self.mock_env)
        self.mock_env.interaction_cache = "October 15 2023 10:00, October 15 2023 14:00"
