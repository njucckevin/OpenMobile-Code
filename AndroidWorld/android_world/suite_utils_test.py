...
class TestCreateSuite(parameterized.TestCase):
    ...
    @parameterized.named_parameters(
        ...
        dict(testcase_name="information_retrieval", family="information_retrieval"),
    )
...
class TestSuite(absltest.TestCase):
    ...
    def setUp(self):
        ...
        self.original_registry = copy.deepcopy(self.task_registry.ANDROID_TASK_REGISTRY)
...
class SuiteUtilsTest(parameterized.TestCase):
    ...
    def test_run_adb_task_instances_initialize_fails(self):
        ...
        failing_instance.initialize_task = lambda: ValueError("Something went wrong")
